...
public class ContentController {
    ...
    public CommonResponse<PagedResponse<ContentResponse>> getAllContents(
        ...
        ContentListRequest request = ContentListRequest.of(null, page, size);
    ...
    public CommonResponse<PagedResponse<ContentResponse>> getContentsBySymbol(
        ...
        ContentListRequest request = ContentListRequest.of(symbol, page, size);
